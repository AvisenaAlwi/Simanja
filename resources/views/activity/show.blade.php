...
'description' => __('halaman berikut menunjukkan detil kegiatan yang yang telah dibuat.'),
'class' => 'col-lg-7'
])
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Detil kegiatan') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div>
                            ...
                            <h6>{{$sub_activity->created_at}}</h6>
                            <h1 class="display-3">{{$sub_activity->activity_name}}</h1>
                            <h4>dibuat oleh: {{$sub_activity->user_name}}</h4>
                            <h4>Periode: {{$sub_activity->bulan_awal}} {{$sub_activity->tahun_awal}} -
                                {{$sub_activity->bulan_akhir}} {{$sub_activity->tahun_akhir}}</h4>
