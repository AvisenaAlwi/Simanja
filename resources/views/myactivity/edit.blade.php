                            ...
                            <div class="row">
                                <div class="col-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="satuan" class="form-control form-control-alternative satuan-sub-kegiatan" value="{{ $my_activity->satuan }}" required>
                                    </div>
                                </div>
                                <div class="col-6 col-lg-3">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-password">Volume Sub Kegiatan 1</label>
                                        <input type="number" name="volume" class="form-control form-control-alternative volume-sub-kegiatan" value="{{ $my_activity->volume }}" required>
                                    </div>
                                </div>
                                <div class="col-6 col-lg-3">
                                    <div class="form-group">
                                ...
                                <div class="col-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.0001" name="angka_kredit" class="form-control form-control-alternative" value="{{ $my_activity->angka_kredit }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
